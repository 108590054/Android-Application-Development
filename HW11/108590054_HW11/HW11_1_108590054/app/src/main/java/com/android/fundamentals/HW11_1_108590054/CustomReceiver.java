...
package com.android.fundamentals.HW11_1_108590054;
...
public class CustomReceiver extends BroadcastReceiver {
    ...
    private static final String EXTRA_MESSAGE = "randomInteger";
        ...
        if (intentAction != null) {
            ...
            switch (intentAction){
                ...
                case ACTION_CUSTOM_BROADCAST:
                    int n = intent.getIntExtra(EXTRA_MESSAGE, -1);
                    toastMessage =
                            context.getString(R.string.custom_broadcast_toast)+ String.valueOf(n * n);
                    break;
            }
