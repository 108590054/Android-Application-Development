...
package com.android.example.HW11_2_108590054;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String ACTION_UPDATE_NOTIFICATION =
            "com.android.example.HW11_2_108590054.ACTION_UPDATE_NOTIFICATION";
    ...
    public void updateNotification() {
        ...
        notifyBuilder.setStyle(new NotificationCompat.InboxStyle()
                .addLine(getString(R.string.text_notice1))
                .addLine(getString(R.string.text_notice2))
                .addLine(getString(R.string.text_notice3))
                .setBigContentTitle(getString(R.string.title_notice)));
